...
<head>
	...
	<title>Lamborghini URUS SE</title>
  ...
  .container {
	...
	* {
	...
	.carousel{
		...
		width: 100%;
		height: 100%;
		background-image: url(urusse/lamborghini_urus_shiny_black_package_4k.jpg);
	...
	.carousel:nth-child(2){
		background: url(urusse/aventadorSVJ.jpg);
		background-size: cover;
		z-index: -1;
	}
	.carousel:nth-child(3){
		background: url(huracan/hura_evo_01.jpg);
		background-size: cover;
		z-index: -1;
	}
	.carousel:nth-child(4){
		background: url(revulto/revuelto_01.jpg);
		background-size: cover;
		z-index: -1;
	}
	.carousel .title{
...
@media only screen and (max-width: 768px){
	...
	.image9003 {
		...
		align-items: center;
		position: relative;
		clip-path: polygon(39% 0%, 100% 0%, 64% 100%, 3% 100%);	
		flex-direction: column;
		overflow: hidden;
	}
...
<div class="row">
		<div class="imgwrapper">
			<img src="urusse/overview_dd.png" class="">
		</div>
		<div class="contentwrapper">
			<div class="content">
				<div class="textwrapper">
			<h2>Overview</h2>	
			<p>Urus SE is the next step in Automobili Lamborghini’s journey toward complete hybridization. As the first PHEV (Plug-in Hybrid Electric Vehicle) version of the luxury Super SUV, the SE sets a new benchmark for the whole segment in terms of comfort, performance, efficiency, emissions, and driving experience.
...
<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/955969561?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Urus SE - Dare To Live More"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
</section>
    ...
    <div class="skewed">
		...
		<div class="image900">
			<div>
				<img src="urusse/image_s_11.png" alt="img" />
			</div>
		</div>
	</div>
	...
	<div class="skewed skewed-left">
		<div class="image9001">
			<div>
				<img src="urusse/image_s_334.png" alt="img" />
			</div>
		</div>
		<div class="text">
	...
	<div class="skewed">
		<div class="image9002">
			<div>
				<img src="urusse/image_s_22.png" alt="img" />
			</div>
		</div>
	</div>
	...
	<div class="skewed skewed-left">
		<div class="image9003">
			<div>
				<img src="urusse/giallo.png" alt="img" />
			</div>
		</div>
	</div>
...
<section class="specs2">
	<ul>
		...
		<li>
			<span>ENGINE</span>
			<span id="in">V8, 90°</span>
		</li>
		<li>
			<span>DISPLACEMENT</span>
			<span id="in">3996 cm³</span>
		</li>
		<li>
			<span>MAX POWER (COMBINED ICE+EE)</span>
			<span id="in">800 CV @ 6000 rpm</span>
		</li>
		<li>
			<span>TOP SPEED</span>
			<span id="in">312 km/h</span>
		</li>
	</ul>
    ...
    <ul>
        ...
        <li>
			<span class="header">COMBINED CONSUMPTION*</span>
			<span id="in">The fuel consumption and emissions data is in the type approval stage</span>
		</li>
        <li>
			<span class="header">COMBINED CO2 EMISSIONS*</span>
			<span id="in">The fuel consumption and emissions data is in the type approval stage</span>
		</li>
        <li>
            <span class="header">VALVES PER CYLINDER</span>
            <span id="in">4</span>
        </li>
        <li>
            <span class="header">BORE X STROKE</span>
            <span id="in">86 mm</span>
        </li>
        <li>
            <span class="header">COMPRESSION RATIO ICE</span>
            <span id="in">9:7:1</span>
        </li>
        <li>
            <span class="header">MAX. TORQUE ICE</span>
            <span id="in">800 Nm @ 2250-4500 rpm</span>
        </li>
        <li>
            <span class="header">SPECIFIC OUTPUT (ICE)</span>
            <span id="in">155 CV/L</span>
        </li>
        <li>
            <span class="header">MAX REVS (ICE)</span>
            <span id="in">6800 rpm</span>
        </li>
        <li>
            <span class="header">MINIMUM ENGINE REV - IDLE</span>
            <span id="in">550 +/- 100 rpm</span>
        </li>
        <li>
            <span class="header">MAXIMUM ENGINE REV - LIMITER</span>
            <span id="in">6800 rpm</span>
        </li>
        </ul>
</div>
...
<div class="section">
    ...
    <ul>
        ...
        <li>
            ...
            <span id="in">5123 mm</span>
        </li>
        <li>
            <span class="header">WIDTH (EXCLUDING MIRRORS)</span>
            <span id="in">2022 mm</span>
        </li>
        <li>
            <span class="header">WIDTH (INCLUDING MIRRORS)</span>
            <span id="in">2181 mm</span>
        </li>
        <li>
            <span class="header">HEIGHT</span>
            <span id="in">1638 mm</span>
        </li>
        <li>
            <span class="header">FRONT TRACK</span>
            <span id="in">1695 mm</span>
        </li>
        <li>
            <span class="header">REAR TRACK</span>
            <span id="in">1710 mm</span>
        </li>
        <li>
            <span class="header">WHEELBASE</span>
            <span id="in">3003 mm</span>
        </li>
        <li>
            <span class="header">FRONT OVERHANG</span>
            <span id="in">1067 mm</span>
        </li>
        <li>
            <span class="header">REAR OVERHANG</span>
            <span id="in">1053 mm</span>
        </li>
        <li>
            <span class="header">WEIGHT DISTRIBUTION</span>
            <span id="in">54/46 %</span>
        </li>
    </ul>
</div>
...
<div class="section">
    ...
    <ul>
        <li>
            <span class="head">SUSPENSION</span>
        </li>
        <li>
            <span class="header">FRONT SUSPENSION</span>
            <span id="in">front suspension with multilink layout, semi-active dampers, pneumatic springs and car height adjustment system.</span>
        </li>
        <li>
            <span class="header">REAR SUSPENSION</span>
            <span id="in">rear suspension with multilink layout, semi-active dampers, pneumatic springs and car height adjustment system. Double steering axle (Rear Wheel Steering)</span>
        </li>
</div>
</ul>
...
<div class="section">
    ...
    <ul>
        ...
        <li>
            ...
            <span id="in">3.4 s</span>
        </li>
        <li>
            <span class="header">ACCELERATION 0-200 KM/H (0-124 MPH)</span>
            <span id="in">11.2 s</span>
        </li>
        <li>
            <span class="header">BRAKING 100-0 KM/H</span>
            <span id="in">33.5m</span>
        </li>
</div>
</ul>
...
<div class="section">
    ...
    <ul>
        ...
        <li>
            ...
            <span id="in">4WD with integrated front differential, hang-on central differential electronic rear differential with torque vectoring</span>
        </li>
        <li>
            <span class="header">GEARBOX</span>
            <span id="in">8-speed automatic gearbox with torque converter</span>
        </li>
    </div>
</ul>
    ...
    <ul>
        ...
        <li>
            ...
            <span id="in">Carbon Ceramic Brakes </span>
        </li>
...
Thickness - 40 mm (1.57 in)</span>
        </li>
        <li>
            <span class="header">REAR BRAKES</span>
            <span id="in">Diameter - 410 mm (16.14 in)
            Thickness - 32 mm (1.26 in)</span>
        </li>
        </div>
    </ul>
    ...
    <ul>
        <li>
            <span class="head">ELECTRIC ENGINE</span>
        </li>
        <li>
            <span class="header">BATTERY</span>
            <span id="in">BATTERY LI-ION E67 BATTypA27</span>
        </li>
        <li>
            <span class="header">BATTERY TOTAL ENERGY</span>
            <span id="in">25.9 kWh</span>
        </li>
        <li>
            <span class="header">REAR EMOTOR - P2P3 10S PEAK POWER @RPM</span>
            <span id="in">141kW @ 3200rpm</span>
        </li>
        <li>
            <span class="header">REAR EMOTOR - P2P3 10S PEAK TORQUE</span>
            <span id="in">483Nm</span>
        </li>
        </div>
    </ul> 
...
<div class="section">
    ...
    <ul>
        ...
        <li>
            <span class="header">STANDARD RIMS FRONT</span>
            <span id="in">9,5Jx21" ET28</span>
        </li>
        <li>
            <span class="header">STANDARD RIMS REAR</span>
            <span id="in">10,5Jx21" ET18</span>
        </li>
        <li>
            <span class="header">STANDARD TIRES FRONT</span>
            <span id="in">285/45 ZR21</span>
        </li>
        <li>
            <span class="header">STANDARD TIRES REAR</span>
            <span id="in">315/40 ZR21</span>
        </li>
    </div>
</ul>
...
<div class="section">
    ...
    <ul>
        ...
        <li>
            <span class="header">BATTERY</span>
            <span id="in">Lithium-ion with prismatic cells</span>
        </li>
        <li>
            <span class="header">ELECTRIC ENGINES</span>
            <span id="in">AC synchronous EM with PM 141 kW @3200 rpm</span>
        </li>
    </div>
</ul>
...
<div class="slider">
        <div class="slides">
            <div class="slide">
                <img src="urusse/s1.jpg" alt="">
            </div>
            <div class="slide">
                <img src="urusse/s_2_d.jpg" alt="">
            </div>
            <div class="slide">
                <img src="urusse/slide3.jpg" alt="">
            </div>
            <div class="slide">
                <img src="urusse/slide4.jpg" alt="">
            </div>
            <div class="slide">
                <img src="urusse/slide5.jpg" alt="">
            </div>
        </div>
