  ...
  .container {
	...
	* {
	...
	.carousel{
		...
		width: 100%;
		height: 100%;
		background-image: url(revulto/9075776.jpg);
	...
	.carousel:nth-child(2){
		background: url(revulto/aaR.jpg);
		background-size: cover;
		z-index: -1;
	}
	.carousel:nth-child(3){
		background: url(revulto/2020-Lamborghini-Aventador-SVJ-63-Roadster-003-2160-scaled.jpg);
		background-size: cover;
		z-index: -1;
	}
	.carousel:nth-child(4){
		background: url(revulto/black-lamborghini-huracan-surface-wallpaper.jpg);
		background-size: cover;
		z-index: -1;
	}
	.carousel .title{
...
.play-pause {
    ...
    height: 100px;
    color: black;
    background: url('revulto/pause2.png') no-repeat center center;
    background-size: contain;
    cursor: pointer;
}
...
.play-pause.playing {
	color: black;
    background: url('revulto/play2.png') no-repeat center center;
    background-size: contain;
}
...
<body>
	...
	<nav class="nav container">
              <a class="nav__logo">
              	<img src="revulto/collage.png" class="brand"/>
              </a>
    ...
    <div class="carousel">
		...
		<div class="carousel">
			...
			<h2 class="ti"> EveryDay <br>Amplified</h2>
...
<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/955880656?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Lamborghini Revuelto – From Now On"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
</section>
	...
	<div class="skewed">
		<div class="image9002">
			<div>
				<img src="revulto/revuelto_s_02.png" alt="img" />
			</div>
		</div>
	</div>
	...
	<div class="skewed skewed-left">
		<div class="image9003">
			<div>
				<img src="revulto/revuelto_s_03.png" alt="img" />
			</div>
		</div>
	</div>
...
<section class="align">
    <div class="con">
        <div class="feature">
            ...
            <p>Listen to the all-encompassing sound of hybridization technology: the unmistakable roar of the V12 aspirated engine coupled with powerful electric motors. Let yourself be swept away by the strength of the new Lamborghini sound.</p>
            <div class="icon-text">
                <img src="revulto/headphones.png" alt="Headphones Icon">
                <p>Use headphones or earphones for a 8D sound experience.</p>
        </div>
        <div class="audio-player">
            <div id="play-pause-button" class="play-pause"></div>
            <audio id="audio" src="revulto/revuelto.mp3"></audio>
        </div>
    </div>
        <div class="feature">
            <h2>CENTRO STILE</h2>
            <p>The Revuelto combines classic Lamborghini proportions with strong, sculpted lines that promise a new future. Explore a silhouette that embodies confidence, power, strength, and groundbreaking aerodynamics.</p>
        </div>
    </div>
</section>
...
<section class="specs2">
	<ul>
		...
		<li>
			<span>ENGINE</span>
			<span id="in">V12 NA 6.5 l</span>
		</li>
		<li>
			<span>DISPLACEMENT</span>
			<span id="in">6498.5 cm³ (396.6 cu in)</span>
		</li>
		<li>
			<span>MAX POWER (COMBINED ICE+EE)</span>
			<span id="in">1015 CV</span>
		</li>
		<li>
			<span>TOP SPEED</span>
			<span id="in">>350 km/h</span>
		</li>
        <li>
			<span>ACCELERATION 0-100 KM/H (0-62 MPH)</span>
			<span id="in">2.5 s</span>
		</li>
        <li>
			<span>COMBINED CONSUMPTION*</span>
			<span id="in">11,86 l/100km (WLTP)</span>
		</li>
        <li>
			<span>COMBINED CO2 EMISSIONS*</span>
			<span id="in">276 g/km (WLTP)</span>
		</li>
        <li>
			<span>POWER CONSUMPTION COMBINED*</span>
			<span id="in">10,1 kWh/100 Km (WLTP)</span>
		</li>
        <li>
			<span>CO2 EFFICIENCY CLASS COMBINED*</span>
			<span id="in">G (WLTP)</span>
		</li>
        <li>
			<span>FUEL CONSUMPTION WITH DISCHARGED BATTERY COMBINED*</span>
			<span id="in">17,8 l/100km (WLTP)</span>
		</li>
        <li>
			<span>CO2 EFFICIENCY CLASS WITH DISCHARGED BATTERY*</span>
			<span id="in">G (WLTP)</span>
		</li>
	</ul>

	<button class="expand-collapse-btn" onclick="toggleContent()"><img src="revulto/Expand all Technical Specifications.png" class="expandimg"></button>
		<div class="collapse">
            <div class="expand">
             	<div class="section">
            <section class="specs">
    <ul>
        <li>
            <span class="head">INTERNAL COMBUSTION ENGINE</span>
        </li>
        <li>
            <span class="header">BORE X STROKE</span>
            <span id="in">95 mm x 76.4 mm (3.74 x 3.01 in)</span>
        </li>
        <li>
            <span class="header">COMPRESSION RATIO</span>
            <span id="in">12.6:1</span>
        </li>
        <li>
            <span class="header">MAX. POWER</span>
            <span id="in">825 CV (607 kW) @ 9250 rpm</span>
        </li>
        <li>
            <span class="header">MAX. TORQUE</span>
            <span id="in">725 Nm @ 6750 rpm</span>
        </li>
        <li>
            <span class="header">WEIGHT TO POWER RATIO</span>
            <span id="in">1.75 kg/CV</span>
        </li>
        <li>
            <span class="header">LUBRICATION</span>
            <span id="in">Dry sump</span>
        </li>
        <li>
            <span class="header">COOLING SYSTEM</span>
            <span id="in">Liquid cooled - dedicated circuit for HV components</span>
        </li>
        <li>
            <span class="header">ENGINE MANAGEMENT SYSTEM
            </span>
            <span id="in">PFI - Bosch</span>
        </li>
        <li>
            <span class="header">EMISSION CLASS</span>
            <span id="in">EU6; LEV III; CN6b</span>
        </li>
        <li>
            <span class="header">EMISSION CONTROL SYSTEM</span>
            <span id="in">4 pre-cats close to engine, 4 lambda sonds</span>
        </li>
        </ul>
</div>
...
<div class="section">
    ...
    <ul>
        <li>
            <span class="head">DIMENSIONS</span>
        </li>
        <li>
            <span class="header">LENGTH</span>
            <span id="in">4947 mm</span>
        </li>
        <li>
            <span class="header">WIDTH (EXCLUDING MIRRORS)</span>
            <span id="in">2033 mm</span>
        </li>
        <li>
            <span class="header">WIDTH (INCLUDING MIRRORS)</span>
            <span id="in">2266 mm</span>
        </li>
        <li>
            <span class="header">HEIGHT</span>
            <span id="in">1160 mm</span>
        </li>
        <li>
            <span class="header">FRONT TRACK</span>
            <span id="in">1720 mm</span>
        </li>
        <li>
            <span class="header">REAR TRACK</span>
            <span id="in">1701 mm</span>
        </li>
        <li>
            <span class="header">WHEELBASE</span>
            <span id="in">2779 mm</span>
        </li>
        <li>
            <span class="header">DRY WEIGHT</span>
            <span id="in">1772 kg</span>
        </li>
        <li>
            <span class="header">WEIGHT DISTRIBUTION</span>
            <span id="in">% 44 / 56</span>
        </li>
    </ul>
</div>
...
<div class="section">
    ...
    <ul>
        ...
        <li>
            ...
            <span id="in">ELECTRONIC STABILITY CONTROL (ESC) integrating ABS and TCS with <br> different characteristics according to the driving mode selected</span>
        </li>
        <li>
            <span class="header">SUSPENSION GEOMETRY</span>
            <span id="in">EPS - Electric Power Steering</span>
        </li>
</div>
</ul>
...
<div class="section">
    ...
    <ul>
        ...
        <li>
            <span class="header">TRANSMISSION</span>
            <span id="in">AMT</span>
        </li>
        <li>
            <span class="header">GEARBOX</span>
            <span id="in">8 Gears</span>
        </li>
        <li>
            <span class="header">CLUTCH</span>
            <span id="in">DUAL CLUTCH</span>
        </li>
    </div>
</ul>
    ...
    <ul>
        ...
        <li>
            ...
            <span id="in">CCB Plus (Carbon Ceramic Brakes Plus) brakes with fixed monoblock <br> calipers in aluminum with 10 pistons (front) and 4 pistons (rear)</span>
        </li>
        
        <li>
            <span class="header">FRONT BRAKES (CARBON CERAMIC BRAKES) </span>
            <span id="in">410x38mm discs</span>
        </li>
        <li>
            <span class="header">REAR BRAKES (CARBON CERAMIC BRAKES)</span>
            <span id="in">390x32mm discs</span>
        </li>
        </div>
    </ul>
    ...
    <ul>
        ...
        <li>
            ...
            <span id="in">Multi-technology carbon fiber monocoque, front structure in Forged Composites</span>
        </li>
        <li>
            <span class="header">BODY</span>
            <span id="in">Carbon fiber body, aluminium doors, thermoplastic front and rear bumpers</span>
        </li>
        <li>
            <span class="header">AERODYNAMICS</span>
            <span id="in">Active rear wing featuring 3 positions according to the different driving modes and driving dynamics</span>
        </li>
        </div>
    </ul> 
...
<div class="section">
    ...
    <ul>
        <li>
            <span class="head">WHEELS</span>
        </li>
        <li>
            <span class="header">FRONT RIMS</span>
            <span id="in">20 x 9.5j (21 x 9.5j optional)</span>
        </li>
        <li>
            <span class="header">REAR RIMS</span>
            <span id="in">21 x 12j (22 x 12.5j optional)</span>
        </li>
        <li>
            <span class="header">FRONT TIRES</span>
            <span id="in">265/35 ZR20 - Potenza Sport Runflat (265/30 ZR21 - Runflat optional)</span>
        </li>
        <li>
            <span class="header">REAR TIRES</span>
            <span id="in">345/30 ZR21 - Potenza Sport Runflat (355/25 ZR22 - Runflat optional)</span>
        </li>
    </div>
</ul>
...
<div class="section">
    ...
    <ul>
        <li>
            <span class="head">HYBRID SYSTEM</span>
        </li>
        <li>
            <span class="header">BATTERY</span>
            <span id="in">Lithium-ion high specific power battery with pouch cells</span>
        </li>
        <li>
            <span class="header">GENERATOR
            </span>
            <span id="in">Rear P2-P3 eMotor (110kW @10000rpm)</span>
        </li>
        <li>
            <span class="header">ELECTRIC ENGINES</span>
            <span id="in">Front e-axle (220kW @3500rpm)</span>
        </li>
    </div>
</ul>
...
<div class="section">
    ...
    <ul>
        ...
        <li>
            ...
            <span id="in">Driver, passenger, side airbags. Knee airbags only for specific markets</span>
        </li>
        </div>
    </ul>
    ...
    <div class="slider">
        <div class="slides">
            <div class="slide">
                <img src="revulto/revuelto_05.jpg" alt="">
            </div>
            <div class="slide">
                <img src="revulto/revuelto_04.jpg" alt="">
            </div>
            <div class="slide">
                <img src="revulto/revuelto_03.jpg" alt="">
            </div>
            <div class="slide">
                <img src="revulto/revuelto_02.jpg" alt="">
            </div>
            <div class="slide">
                <img src="revulto/revuelto_01.jpg" alt="">
            </div>
        </div>
