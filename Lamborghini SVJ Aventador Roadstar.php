...
<head>
	...
	<title>Lamborghini SVJ Aventador Roadstar</title>
  ...
  .container {
	...
	* {
	...
	.carousel{
		...
		width: 100%;
		height: 100%;
		background-image: url(aventador2.jpg);
	...
	.carousel:nth-child(2){
		background: url(aventador/evo2.jpg);
		background-size: cover;
		z-index: -1;
	}
	.carousel:nth-child(3){
		background: url(aventador/lamborghini-revuelto-2024-8b-1920x1080.jpg);
		background-size: cover;
		z-index: -1;
	}
	.carousel:nth-child(4){
		background: url(urusse/image_s_11.png);
		background-size: cover;
		z-index: -1;
	}
	.carousel .title{
...
@media only screen and (max-width: 768px){
	...
	.image900 {
		...
		align-items: center;
		position: relative;
        clip-path: polygon(30% 0, 100% 0%, 82% 100%, 5% 100%);
		flex-direction: column;
		overflow: hidden;
	}
	.image9001 {
		...
		align-items: center;
		position: relative;
		clip-path: polygon(0 0, 75% 0, 100% 100%, 20% 100%);
		flex-direction: column;
		overflow: hidden;
	}
    .image9002 {
...
.play-pause {
    ...
    height: 100px;
    color: black;
    background: url('pause2.png') no-repeat center center;
    background-size: contain;
    cursor: pointer;
}
...
<div class="row">
		<div data-aos="fade-down" data-aos-easing="linear" data-aos-delay="100" class="imgwrapper">
			<img src="aventador/ar_aven_svj_rds_01.png">
		</div>
		<div class="contentwrapper">
			<div class="content">
				<div data-aos="fade-down" data-aos-easing="linear" data-aos-delay="100" class="textwrapper">
			<h2>Overview</h2>	
			<p data-aos="fade-down" data-aos-easing="linear" data-aos-delay="100">Limited to a mere 800 examples, the SVJ Roadster is the most iconic form of the Aventador family.Its Lamborghini aerodynamics represent the most futuristic ever designed: the ALA 2.0 system and aero-vectoring ensure the minimum drag on straightaways and the optimal aerodynamic load when cornering.The 770 hp naturally aspirated V12 engine inspires awe.</p>
		    </div>
		</div>
	</div>
</div>
...
<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/950215055?h=5e71df2fa1&loop=1" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
</section>
	...
	<div class="skewed skewed-left">
		<div data-aos="fade-left" data-aos-easing="linear" data-aos-delay="100" class="image9001">
			<div>
				<img src="aventador/interior.jpg" alt="img" />
			</div>
		</div>
		<div class="text">
			<h1 data-aos="fade-down" data-aos-easing="linear" data-aos-delay="100" class="exp">Interior Design</h1>
			<p data-aos="fade-down" data-aos-easing="linear" data-aos-delay="100" class="inp">The technological look of carbon fiber, featured in the monocoque as well as the doors, seats, center tunnel and console, coexists with a design of clear aeronautical inspiration, while the leather and Alcantara upholstery adds a bold touch of exclusivity to the luxurious interior. But it is the refined details of the cross-stitching and special SVJ Roadster plaque that confer a truly unique character to this remarkable automobile</p>
		</div>
	</div>
    ...
    <div class="skewed">
		<div class="image9002">
			<div>
				<img src="aventador/aventador.jpg" alt="img" />
			</div>
		</div>
	</div>
	...
	<div class="skewed skewed-left">
		<div class="image9003">
			<div>
				<img src="aventador/ai.png" alt="img" />
			</div>
		</div>
	</div>
...
<section class="align">
    <div class="con">
        <div class="feature">
            ...
            <p>The unmistakable roar of the Lamborghini engine blends in with the sound of the wind: a perfect symphony for an adrenalin-packed driving experience.</p>
            <div class="icon-text">
                <img src="aventador/headphones.png" alt="Headphones Icon">
                <p>Use headphones or earphones for a 8D sound experience.</p>
        </div>
        <div class="audio-player">
            <div id="play-pause-button" class="play-pause"></div>
            <audio id="audio" src="aventador/music.mp3"></audio>
        </div>
    </div>
        <div class="feature">
            <h2>CENTRO STILE</h2>
            <p>A heartthrob made possible by perfect aerodynamics and cutting-edge technology, with an uncompromising look to the future. The breathtaking design sports aerodynamic lines that slice through the air, delivering thrilling performance as you touch the sky.</p>
        </div>
    </div>
</section>
...
<section class="specs2">
	<ul>
		...
		<li>
			<span>ENGINE</span>
			<span>V12, 60°, MPI (Multi Point Injection)</span>
		</li>
		<li>
			<span>MAX. TORQUE</span>
			<span>720 Nm @ 6,750 rpm</span>
		</li>
		<li>
		...
		<li>
			<span>MAX. POWER</span>
			<span>770 CV (566 kW) @ 8,500 rpm</span>
		</li>
	</ul>

	<button class="expand-collapse-btn" onclick="toggleContent()"><img src="Expand all Technical Specifications.png" class="expandimg"></button>
		<div class="collapse">
            <div class="expand">
             	<div class="section">
            <section class="specs">
    ...
    <ul>
        ...
        <li>
            <span class="header">ENGINE</span>
            <span>V12, 60°, MPI (Multi Point Injection)</span>
        </li>
        <li>
            <span class="header">DISPLACEMENT</span>
            <span>6,498 cm³</span>
        </li>
        <li>
            <span class="header">BORE X STROKE</span>
            <span>95 mm x 76.4 mm (3.74 x 3.01 in)</span>
        </li>
        <li>
...
<div class="section">
    ...
    <ul>
        ...
        <li>
            ...
            <span>Electronic Stability Control (integrated ABS) with different ESP <br> charecteristics managed by drive select mode</span>
        </li>
        <li>
            <span class="header">SUSPENSION TYPE</span>
            <span>Push rod magneto rheologic active front and rear suspension <br> with horizontal dampers and springs</span>
        </li>
        <li>
            <span class="header">SUSPENSION GEOMETRY</span>
            <span>Aluminium double-wishbone fully independent front <br> and rear suspension</span>
        </li>
        <li>
            <span class="header">STEERING SYSTEM</span>
            <span>Hydraulic assisted power steering</span>
        </li>
        <li>
            <span class="header">STEERING SYSTEM</span>
            <span>LDS (Lamborghini Dynamic Steering) and Rear Wheel Steering <br> (RWS), managed by drive select mode</span>
        </li>
</div>
</ul>
...
<div class="section">
    ...
    <ul>
        ...
        <li>
            ...
            <span>Electronically controlled all-wheel drive system (Haldex gen. IV) <br> with rear mechanical self-locking differential</span>
        </li>
        <li>
            <span class="header">GEARBOX</span>
            <span>ISR (Independent Shifting Rods) gearbox with 7 speeds, <br> shifting characteristic depending on drive select mode</span>
        </li>
    </div>
</ul>
    ...
    <ul>
        ...
        <li>
            ...
            <span>Dual hydraulic circuit brake system with vacuum brake booster; front and rear CCB, (6-cylinder brake calipers with 400 mm diameter and 38 mm thickness)</span>
        </li>
        <li>
            <span class="header">REAR BRAKES</span>
            <span>Dual hydraulic circuit brake system with vacuum brake booster; front and rear CCB, (4-cylinder brake calipers with 380 mm diameter and 38 mm thickness)</span>
        </li>
        </div>
    </ul>
    ...
    <ul>
        ...
        <li>
            ...
            <span>Front dual stage driver airbag and front adaptive passenger airbag; <br> seats with side “head-thorax” airbags; knee airbags in selected markets</span>
        </li>
        <li>
        ...
        <li>
            ...
            <span>Electronic Stability Control (integrated ABS) with <br> different ESP charecteristics managed by drive select mode</span>
        </li>
        </div>
    </ul>
    ...
    <ul>
        ...
        <li>
            ...
            <span>Carbon fiber monocoque <br> with aluminium front and rear frames</span>
        </li>
        <li>
            <span class="header">BODY</span>
            <span>Carbon fiber engine hood, fix side air inlets, rocker cover with increased air inlets. Front and rear lightweight bumper. Front diffuser and fixed spoiler with ALA system and aero-vectoring. High pressure RTM carbon fiber Hard Top</span>
        </li>
        <li>
        ...
        <li>
            ...
            <span>Fixed spoiler with ALA system included <br> and with Aero Vectoring system</span>
        </li>
        </div>
    </ul>
    ...
    <ul>
        ...
        <li>
            ...
            <span>4,943 mm (194.61 in)</span>
        </li>
        <li>
            <span class="header">WIDTH (EXCLUDING MIRRORS)</span>
            <span>2,098 mm (82.60 in)</span>
        </li>
        <li>
            <span class="header">WIDTH (INCLUDING MIRRORS)</span>
            <span>2,273 mm (89.49 in)</span>
        </li>
        <li>
            <span class="header">HEIGHT</span>
            <span>1,136 mm (44.72 in)</span>
        </li>
        <li>
            <span class="header">WHEELBASE</span>
            <span>2,700 mm (106.30 in)</span>
        </li>
        <li>
...
<div class="slider">
        <div class="slides">
            <div class="slide">
                <img src="aventador/1.jpg">
            </div>
            <div class="slide">
                <img src="aventador/2.jpg">
            </div>
            <div class="slide">
                <img src="aventador/3.jpg">
            </div>
            <div class="slide">
                <img src="aventador/4.jpg">
            </div>
            <div class="slide">
                <img src="aventador/5.jpg">
            </div>
        </div>
